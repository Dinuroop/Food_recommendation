...
profiles = pd.read_csv('C:\\Users\\SUVARNA\\Food Recommendation\\Data Processing\\user_Profiles.csv') # profiles of all users
recent_activity = pd.read_csv('C:\\Users\\SUVARNA\\Food Recommendation\\Data Processing\\recent_activity.csv') # recent activities of current user (meals liked,rated,searched,Purchased)
dataset = pd.read_csv('C:\\Users\\SUVARNA\\Food Recommendation\\Data Processing\\dataset.csv') # main dataset
