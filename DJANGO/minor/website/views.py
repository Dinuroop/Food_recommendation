...
def buy(request):
    ...
    filename=r"C:\\Users\\SUVARNA\\Food Recommendation\\DJANGO\\minor\\website\\csvfile\\recent_activity.csv"
...
def order(request):
    if Profile.objects.get(number=request.user.username).second_time:
        filename=r"C:\\Users\\SUVARNA\\Food Recommendation\\DJANGO\\minor\\website\\csvfile\\recent_activity.csv"
        filename2=r"C:\\Users\\SUVARNA\\Food Recommendation\\DJANGO\\minor\\website\\dataset.csv"
